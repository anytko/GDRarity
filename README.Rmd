...
- build_treemap() visualizes eco-evolutionary rarity categories using a treemap
...
We can map the EER of species from this dataframe onto 2D and interactive 3D space. This object can be manipulated and positioned by the user in order to best visualize the respective ecological statuses. 

``` {r Create 2d Visualization, eval=FALSE}
