...
#' 
#' @param choice Choice of seed phylogney includes ALLMB, ALLOTB, GBMB, GBOTB
#' 
...
#' 
#' @return A rooted phylogenetic object to be used in comparitive methods
#' 
#' @import ape
#' 
...
#' \insertRef{Magallón2015}{EcoStatusR}
#' 
#' @export 
#' 
